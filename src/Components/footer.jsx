...
const footer = () => {
  return (
    <div className="foot bg-gradient-to-r from-black to-green-500 ">
      <div className="flex flex-wrap">
        ...
        <div  className="p-5 lg:p-10 w-full md:w-1/3 mt-[6rem]">
          ...
          <p class="text-gray-400 mt-3">
            <a href="tel:+910000000000">+91 9566161765</a>
            <br />
            <a href="mailto:contact@gmail.com">manisharma@gmail.com</a>
            <p>Location</p>
